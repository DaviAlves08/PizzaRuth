...
function CardCarroselDoce() {
  ...
  const cadastroPedidoPizzaDoce = async (e) => {
    e.preventDefault();
    try {
  ...
  return (
    <div className="w-full overflow-hidden px-2">
      <h1 className="text-black mt-10 ml-4 text-2xl md:text-4xl">Pizzas Doces</h1>
      <Swiper
        effect={"coverflow"}
        grabCursor={true}
        loop={true}
        ...
        pagination={{ el: ".swiper-pagination-doce", clickable: true }}
        navigation={{ nextEl: ".swiper-next-doce", prevEl: ".swiper-prev-doce", clickable: true }}
      ...
      >
        ...
        <div className="flex justify-center items-center gap-4 mt-4">
          <div className="swiper-prev-doce swiper-button-prev slider-arrow"></div>
          <div className="swiper-pagination-doce swiper-pagination"></div>
          <div className="swiper-next-doce swiper-button-next slider-arrow"></div>
        </div>
      </Swiper>

      <Dialog open={open} handler={() => setOpen(false)} size="xs">
        <form onSubmit={cadastroPedidoPizzaDoce}>
          <div className="flex flex-col text-black p-4">
            ...
            <div className="flex flex-col mt-1 ml-8">
              <Radio name="type-d" label="Pequena" checked={tamanhoSelecionado === 'Pequena'} value={tamanho} onChange={() => atualizarTamanho('Pequena')} />
              <Radio name="type-d" label="Media" checked={tamanhoSelecionado === 'Media'} value={tamanho} onChange={() => atualizarTamanho('Media')} />
              <Radio name="type-d" label="Grande" checked={tamanhoSelecionado === 'Grande'} value={tamanho} onChange={() => atualizarTamanho('Grande')} />
            </div>
...
export default CardCarroselDoce;
