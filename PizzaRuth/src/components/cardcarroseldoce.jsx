...
function CardCarroselDoce() {
  const [pizzas_doces, setPizzasDoces] = useState([]);
  ...
  return (
    ...
    <div className="container">
      <h1 className="heading text-black ml-10 text-4xl">Pizzas Doces</h1>
      <Swiper
        effect={'coverflow'}
        grabCursor={true}
        loop={true}
      ...
      <Dialog open={open} handler={() => setOpen(false)} size="lg">
        <form onSubmit={(e) => cadastroPedidoPizzaDoce(e)}>
